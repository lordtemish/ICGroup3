package com.studio.crm.icgroup.NotificationFragments;
...
import com.studio.crm.icgroup.Adapters.NotificationAdapter;
import com.studio.crm.icgroup.Adapters.PagesAdapter;
import com.studio.crm.icgroup.Adapters.ServicesAdapter;
import com.studio.crm.icgroup.Adapters.TechnoMapAdapter;
...
import com.studio.crm.icgroup.Forms.NotificationForm;
import com.studio.crm.icgroup.Forms.OlkForm;
import com.studio.crm.icgroup.Forms.ServiceForm;
import com.studio.crm.icgroup.Forms.TechnoMapForm;
...
public class NotificationFragment extends Fragment {
    ...
    RecyclerView recyclerView, reqRecycler,pagesRecyclerBot, pagesRecyclerUp, taskTypesRecyclerView;
    PagesAdapter pagesAdapter;
    EquipmentReqAdapter reqAdapter, taskTypeAdapter;
    ...
    List<String> pages, tPages, cPages, cIds, tasktypes;
    ...
    int page=0, tPage=1,cPage=0,page_count=0, tasktype=0;
    ...
    private void setPage(int a){
        ...
        taskTypesRecyclerView.setVisibility(View.GONE);
        ...
        switch (a){
            ...
            case 5:
                ...
                default:
                    ...
                    taskTypesRecyclerView.setVisibility(View.VISIBLE);
                    tPage=1;
