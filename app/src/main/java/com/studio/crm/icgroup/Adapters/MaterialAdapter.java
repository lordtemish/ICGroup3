...
import com.studio.crm.icgroup.ObjectFragments.InventoryEquipmentInfoFragment;
import com.studio.crm.icgroup.ObjectFragments.InventoryMaterialAddFragment;
import com.studio.crm.icgroup.ObjectFragments.InventoryMaterialInfoFragment;
            ...
            try{
                ...
                if(array.length()>0){
                    ...
                    for(int i=0;i<array.length();i++) {
                        ...
                        Date created = ((MainActivity) context).getNowDate(created_at), dead = ((MainActivity)context).getNowDate(deadline);
                        Date now = new Date();
