...
import com.studio.crm.icgroup.Adapters.MainEmployeesAdapter;
...
public class FactoryDepFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i=0;i<((MainActivity)getActivity()).typeRoles.get(kind).size();i++){
            final String a=((MainActivity)getActivity()).typeRoles.get(kind).get(i);
            listeners.add(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    setInfoFragment.setVisibility(View.GONE);
                    rlid=((MainActivity)getActivity()).rlids.get(((MainActivity)getActivity()).roles.indexOf(a));
                    setDp();
                }
            });
        }
        ...
        setInfoFragment.setList(((MainActivity)getActivity()).typeRoles.get(kind));
